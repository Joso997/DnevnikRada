...
{
    public partial class stanje_poduzeća : Form
    {
        public stanje_poduzeća()
        {
            InitializeComponent();
        }

        private void stanje_poduzeća_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void stanje_poduzeća_Load(object sender, EventArgs e)
        {
